  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/track-package" element={<ProtectedRoute><TrackPackage /></ProtectedRoute>} />
        <Route path="/shipment-history" element={<ProtectedRoute><ShipmentHistory /></ProtectedRoute>} />
        <Route path="/update-shipment/:id" element={<ProtectedRoute><UpdateShipment /></ProtectedRoute>} />
